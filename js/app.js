...
function updateLocoScroll(e) {
    ...
    t = "transformation" == r ? "#5aa63d" : "mobility" == r ? "#5D9C11" : "interactive-marketing" == r ? "#0d53bd" : "commerce" == r ? "#13B0A8" : "#000000", e.on("scroll", e => {
        e.scroll.y > 50 ? "index.php" == r || "" == r || "about.php" == r || "contact.php" == r || "website-development.php" == r || "graphic-designing.php" == r || "digital-marketing.php" == r || "seo-content-writing.php" == r || "app-development.php" == r || "ui-ux-designing.php" == r || "services.php" == r || "portfolio.php" == r ? $("header").addClass("bg-black") : ($("header").removeClass("bg-black"), $(".mini-inner-header").css("visibility", "visible")) : "index.php" == r || "" == r || "about.php" == r || "contact.php" == r || "website-development.php" == r || "graphic-designing.php" == r || "digital-marketing.php" == r || "seo-content-writing.php" == r || "app-development.php" == r || "ui-ux-designing.php" == r || "services.php" == r || "portfolio.php" == r ? $("header").removeClass("bg-black") : ($("header").removeClass("bg-black"), $("header").css("background-color", ""), $(".mini-inner-header").css("visibility", "hidden"))
    });
    let s = null;
    setTimeout(() => {
        e.on("call", (e, i, t) => {
            ("index.php" == r || "" == r || "about.php" == r || "contact.php" == r || "website-development.php" == r || "graphic-designing.php" == r || "digital-marketing.php" == r || "seo-content-writing.php" == r || "app-development.php" == r || "ui-ux-designing.php" == r || "services.php" == r || "portfolio.php" == r) && "enter" === i ? "toggleActive" === e && ($(".main-nav a").removeClass("active"), $("section").removeClass("active"), $('a[href*="' + t.id + '"]').addClass("active")) : "enter" === i && "innerToggleActive" === e && ($(".linking-slider a").removeClass("move"), "#corral" == t.id ? ($(".corralperfone").addClass("move"), $(".corralperfone").addClass("safee"), s = $(".corralperfone").parent().attr("aria-label")) : "#corral-performance" == t.id ? ($(".corralperftwo").addClass("move"), s = $(".corralperftwo").parent().attr("aria-label")) : ($(".corralperfone").removeClass("move"), $(".corralperftwo").removeClass("move"), $('a[href*="' + t.id + '"]').addClass("move"), s = $('a[href|="' + t.id + '"]').parent().attr("aria-label")), void 0 !== s && (s = s.substring(0, 1), IntrSwiper.slideTo(s - 1)))
        })
    }, 100)
}
